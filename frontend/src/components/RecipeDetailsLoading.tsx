    ...
    return (
      ...
      >
        ...
        <Box 
          ...
          zIndex={1}
    >
          <Skeleton zIndex={1} height="3rem" width="25rem" borderRadius="lg" speed={2}/>
        </Box>
        ...
        <Flex direction={{ base: "column", md: "row" }} px={6} pb={10} gap={6}>
          ...
          <VStack align="start" spacing={6} width={{ base: "100%", md: "30%" }}>
            <Box width={"100%"}>
          <Skeleton height="30px" width="150px" borderRadius="md" mb={2} speed={2}/>
            <SkeletonText noOfLines={8} spacing={4} width="20%" speed={2}/>
            </Box>
            <Box>
            <Skeleton height="30px" width="150px" borderRadius="md" mb={2} speed={2}/>
            <SkeletonText noOfLines={1}  width="10%" speed={2}/>
            </Box>
            <Box>
            <Skeleton height="30px" width="150px" borderRadius="md" mb={2}speed={2}/>
             <Stack direction="row" spacing={1} mt={2} flexWrap={"wrap"}>
            <Skeleton height="20px" width="60px" borderRadius="md" speed={2}/>
            </Stack>
            </Box>
          ...
          {/* Divider */}
          <Skeleton height="400px" width="2px" display={{ base: "none", md: "block" }} speed={2}/>
  

   {/* Recipe text */}
          <VStack align="start" spacing={6} width={{ base: "100%", md: "70%" }}>
          <SkeletonText noOfLines={1}  width="20%" speed={2}/>
            <SkeletonText noOfLines={6} spacing={4} width="70%" mb={4} speed={2}/>
            <SkeletonText noOfLines={1}  width="20%" speed={2}/>
